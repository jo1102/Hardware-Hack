...
// WiFi credentials
// ===========================
// Kept out of git. Copy wifi_secrets.example.h to wifi_secrets.h in this
// folder and put your own network in it:
//
//     cp camera/XiaoCam/wifi_secrets.example.h camera/XiaoCam/wifi_secrets.h
//
// The __has_include guard means a fresh clone still COMPILES without that
// file - it just will not connect, and the compiler says why. Breaking the
// build for a missing secret would be a worse trade.
#if __has_include("wifi_secrets.h")
  #include "wifi_secrets.h"
#else
  #define WIFI_SSID     "YOUR_WIFI_NAME"
  #define WIFI_PASSWORD "YOUR_WIFI_PASSWORD"
  #warning "camera/XiaoCam/wifi_secrets.h missing - copy wifi_secrets.example.h to it"
#endif
